...
import { buildPayLoan } from '../../application/services/frendlend-service.js';
...
import { claimIdOption, paymentAmountOption, tokenOption } from '../options/frendlend-options.js';
...
export const frendlendPayLoanBuildCommand = Command.make(
    ...
    ({ chain, claimId, paymentAmount, token, format }) =>
        Effect.gen(function* () {
            ...
            const tx = yield* buildPayLoan(params, tokenResult.right);
